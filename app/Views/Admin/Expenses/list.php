<div class="content-wrapper" id="viewpage">
    ...
    <section class="content-header">
        <h1>Expenses <small>Expenses List</small></h1>
        <ol class="breadcrumb">
                    ...
                    <form id="roleUpdateform" action="<?= base_url('Admin/Role/modulePermissionAction')?>" method="post">
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <select class="form-control" onchange="rolePermission(this.value,'Expenses')" name="role_id">
                                            <option value="">Please Select</option>
                                            <?php  foreach (userRole() as $val ){ ?>
                                                <option value="<?= $val->role_id;?>"><?= $val->role;?></option>
                                            <?php } ?>
                                        </select>
                                        <input type="hidden" name="moduleName" value="Expenses">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <a href="javascript:void(0)"
                                   onclick="showData('<?php echo site_url('/Admin/Expenses_ajax/create/'); ?>','<?php echo '/Admin/Expenses/create/'; ?>')"
