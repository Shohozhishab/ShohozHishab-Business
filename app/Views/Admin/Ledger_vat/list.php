                    ...
                    <form id="roleUpdateform" action="<?= base_url('Admin/Role/modulePermissionAction')?>" method="post">
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <select class="form-control" onchange="rolePermission(this.value,'Ledger_vat')" name="role_id">
                                            <option value="">Please Select</option>
                                            <?php  foreach (userRole() as $val ){ ?>
                                                <option value="<?= $val->role_id;?>"><?= $val->role;?></option>
                                            <?php } ?>
                                        </select>
                                        <input type="hidden" name="moduleName" value="Ledger_vat">
                                    </div>
                        ...
                        <div class="box-body">
                            <form action="<?= base_url('Admin/Ledger_vat') ?>" method="get">
                                <div class="row">
                                    ...
                                    <div class="col-md-2" style="margin-top: 25px;">
                                        <a href="<?= base_url('Admin/Ledger_vat') ?>" class="btn btn-default btn-block"><i
