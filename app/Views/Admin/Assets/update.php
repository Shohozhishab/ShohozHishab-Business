<div class="content-wrapper" id="viewpage">
    ...
    <section class="content-header">
        <h1> Assets <small>Assets Update</small> </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Assets Update </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6" >
                                <form id="geniusform" action="<?php echo $action; ?>" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?= $accounts->name?>" required/>
