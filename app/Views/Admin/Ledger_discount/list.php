<div class="content-wrapper" id="viewpage">
    ...
    <section class="content-header">
        <h1> Discount Ledger <small>Discount Ledger</small></h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Discount Ledger</li>
        </ol>
    </section>
                    ...
                    <form id="roleUpdateform" action="<?= base_url('Admin/Role/modulePermissionAction')?>" method="post">
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <select class="form-control" onchange="rolePermission(this.value,'Ledger_discount')" name="role_id">
                                            <option value="">Please Select</option>
                                            <?php  foreach (userRole() as $val ){ ?>
                                                <option value="<?= $val->role_id;?>"><?= $val->role;?></option>
                                            <?php } ?>
                                        </select>
                                        <input type="hidden" name="moduleName" value="Ledger_discount">
                                    </div>
                        ...
                        <table class="table table-bordered table-striped" id="example1">
                            ...
                            for($i = $totalRows; $i >= 0; $i--) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $ledger_discount_data[$i]->createdDtm ?></td>
