<div class="content-wrapper" id="viewpage">
    ...
    <section class="content-header">
        <h1> Bank Withdraw <small> Bank Withdraw Transaction Flow</small></h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12" style="margin-bottom: 15px;">
                <a href="#" onclick="showData('<?php echo site_url('/Admin/Bank_withdraw_ajax'); ?>','<?php echo '/Admin/Bank_withdraw'?>')" class="btn btn-danger btn-sm" style="">Back list</a>
            </div>
