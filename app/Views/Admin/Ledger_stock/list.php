                    ...
                    <form id="roleUpdateform" action="<?= base_url('Admin/Role/modulePermissionAction')?>" method="post">
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <select class="form-control" onchange="rolePermission(this.value,'Ledger_stock')" name="role_id">
                                            <option value="">Please Select</option>
                                            <?php  foreach (userRole() as $val ){ ?>
                                                <option value="<?= $val->role_id;?>"><?= $val->role;?></option>
                                            <?php } ?>
                                        </select>
                                        <input type="hidden" name="moduleName" value="Ledger_stock">
                                    </div>
            ...
            <?php if (isset($filter) && $filter == 1){ ?>
                <div class="col-xs-12" >
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form action="<?= base_url('Admin/Ledger_stock') ?>" method="get">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2" style="margin-top: 25px;">
                                        <a href="<?= base_url('Admin/Ledger_stock') ?>" class="btn btn-default btn-block"><i
                        ...
                        <table class="table table-bordered table-striped" id="example1">
                            ...
                            for ($i = 0; $i <= $totalRows; $i++) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo showWithCurrencySymbol($ledger_stock[$i]->r_balance) ?></td>
                                </tr>
                            <?php }?>
                ...
                <div class="row no-print" >
                    <div class="col-xs-12">
                        ...
                        <?php if (isset($download_PDF) && $download_PDF == 1){ ?>
                            <button type="button" class="btn btn-info pull-right" style="margin-right: 10px;" onclick="downloadPDF('ledgPrint','stock')"><i class="fa fa-file-pdf-o "></i> Download PDF </button>
                        <?php } ?>
                        <?php if (isset($download_CSV) && $download_CSV == 1){ ?>
                            <button type="button" class="btn btn-success pull-right" style="margin-right: 10px;" onclick="downloadCSV('ledgPrint','stock')"><i class="fa fa-file-excel-o "></i> Download CSV</button>
                        <?php } ?>
                    </div>
                </div>
            </div>
