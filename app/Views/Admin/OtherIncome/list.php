<div class="content-wrapper" id="viewpage">
    ...
    <section class="content-header">
        <h1>Other Income <small>Other Income List</small></h1>
        <ol class="breadcrumb">
                    ...
                    <form id="roleUpdateform" action="<?= base_url('Admin/Role/modulePermissionAction')?>" method="post">
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <select class="form-control" onchange="rolePermission(this.value,'OtherIncome')" name="role_id">
                                            <option value="">Please Select</option>
                                            <?php  foreach (userRole() as $val ){ ?>
                                                <option value="<?= $val->role_id;?>"><?= $val->role;?></option>
                                            <?php } ?>
                                        </select>
                                        <input type="hidden" name="moduleName" value="OtherIncome">
                                    </div>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-lg-9">
                                <h3 class="box-title">Other Income List</h3>
                            </div>
                            <div class="col-lg-3">
                                <?php if (isset($create) && $create == 1){ ?>
                                    <a href="javascript:void(0)"
                                       onclick="showData('<?php echo site_url('/Admin/Other_income_ajax/create/'); ?>','<?php echo '/Admin/Other_income/create/'; ?>')"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (isset($update) && $update == 1){ ?>
                                            <a href="javascript:void(0)" onclick="showData('<?php echo site_url('/Admin/Other_income_ajax/update/' . $val->account_id); ?>','<?php echo '/Admin/Other_income/update/' . $val->account_id; ?>')"
                                               class="btn btn-warning btn-xs">Update</a>
                                        <?php } ?>
                                        <?php if (isset($delete) && $delete == 1){ ?>
                                            <?php if($isDeletable == true){ ?>
                                                <a href="<?php echo site_url('/Admin/Other_income/delete/' . $val->account_id); ?>" onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-danger btn-xs">Delete</a>
                                            <?php } ?>
                                        <?php } ?>
                                    </td>
                                </tr>
