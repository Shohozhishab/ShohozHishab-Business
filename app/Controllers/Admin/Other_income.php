...
class Other_income extends BaseController
{
        ...
        if ($this->validation->run($data) == FALSE) {
            ...
            if ($amount !== '0') {
                ...
                $lonLedgdata = array(
                    'sch_id' => $shopId,
                    'account_id' => $account_id,
                    'particulars' => 'Other Income last balance ',
                    'trangaction_type' => 'Dr.',
                    'amount' => $amount,
                    'rest_balance' => $amount,
                    'createdBy' => $userId,
                ...
                $capLedgdata = array(
                    'sch_id' => $shopId,
                    'particulars' => 'Other Incomes (' . $data['name'] . ') is added with existing balance',
                    'trangaction_type' => 'Cr.',
                    'amount' => $amount,
                    'rest_balance' => $newcap,
                    'createdBy' => $userId,
    ...
    public function delete($account_id){
        ...
        return redirect()->to(site_url('Admin/Other_income'));
    }
